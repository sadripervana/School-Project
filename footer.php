  ...
  <div class="container">
    ...
    <div class="swiper-container">
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <a href="#">
            <img src="./assets/slider/img2.jpeg" class="img-fluid" alt="">
          </a>
        </div>
        <!-- Slides -->
        <!-- Slides -->
        <div class="swiper-slide">
          <a href="#">
            <img src="./assets/slider/img3.jpeg" class="img-fluid" alt="">
          </a>
        </div>
        <!-- Slides -->
        <!-- Slides -->
        <div class="swiper-slide">
          <a href="#">
            <img src="./assets/slider/img4.jpeg" class="img-fluid" alt="">
          </a>
        </div>
        <!-- Slides -->
        <div class="swiper-slide">
          <a href="#">
            <img src="./assets/slider/img5.jpeg" class="img-fluid" alt="">
          </a>
        </div>
        <!-- Slides -->
        <div class="swiper-slide">
          <a href="#">
            <img src="./assets/slider/img6.jpeg" class="img-fluid" alt="">
          </a>
        </div>
        <!-- Slides -->
        <div class="swiper-slide">
        ...
        <div class="swiper-slide">
          <a href="#">
            <img src="./assets/slider/img8.jpg" class="img-fluid" alt="">
          </a>
        </div>
        <!-- Slides -->
      ...
      <div class="col-3">
        ...
        <div class="secondary-title text-secondary">
          ...
          <address class="">
            ...
            5 South Main Street Los Angeles,ZZ-432 USA
          </address>
          <div class="phone">
        ...
        <div class="feature-post">
          <div class="flex-item">
            <article class="articel">
              <div class="d-flex">
                <a href="#">
                  <img src="./assets/img2.jpeg" class="object-fit px-1" alt="">
                  <div class="px-1">
                    <a href="#" class="text-title display -2 text-dark">
                      Looking for some feedback fo this rejected track technology
                    </a>
